...
class Compra {    
    ...
    registraItemDeCompra(itemDeCompra) {
        ...
        tdPrecoTotalDoItem.textContent = precoTotalDoItem
        ...
        valorTotalDaCompra.textContent = this.valorTotalDaCompra
...
registrar.addEventListener("click", function(event) {
    ...
    let itemDeCompra = new ItemDeCompra(produto.value, quantidade.value, precoUnitario.value)
