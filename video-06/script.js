...
class Compra {    
    ...
    imprimeNotaFiscal() {
        ...
        for (let i = 0; i < this.itensDeCompra.length; i++) {
            console.log("Produto Comprado: " + this.itensDeCompra[i].produtoComprado)
            console.log("Quantidade Comprada: " + this.itensDeCompra[i].quantidadeComprada)
            console.log("Preço Unitário: " + this.itensDeCompra[i].precoUnitario)
            console.log("Preço Total Do Item: " + this.itensDeCompra[i].precoUnitario * compra.itensDeCompra[i].quantidadeComprada)
            console.log("Valor Total Da Compra: " + this.valorTotalDaCompra)
        }
